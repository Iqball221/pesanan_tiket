         ...
         <div class="banner-main">
            ...
            <div class="container">
               <div class="text-bg">
                  ...
                  <div class="container">
                     <form action="{{ route('dataTransaksi.store') }}" class="main-form" >
                        @csrf
                           ...
                           <div class="col-md-9">
                              <div class="row">
                                 ...
                                 <div class="col-xl-4 col-lg-4 col-md-4 col-sm-6 col-6">
                                    ...
                                    <input class="form-control" type="text" name="asal_berangkat">
                                 </div>

                                 <div class="col-xl-4 col-lg-4 col-md-4 col-sm-6 col-6">
                                    <label >Tujuan Berangkat</label>
                                    <input class="form-control" type="text" name="tujuan_berangkat">
                                 </div>

                                 <div class="col-xl-4 col-lg-4 col-md-4 col-sm-6 col-6">
                                    <label>No Duduk</label>
                                    <input type="text" name="no_duduk" class="form-control">
                                 </div>
                              ...
                              <button type = "submit" class = "main_bt">Pesan</button>
                           </div>
                              </div>
                           </div>
                        </div>
      ...
      <footer>
         <div id="contact" class="footer">
            <div class="container">
               ...
               <div class="copyright">
                  <div class="container">
                     <p>Copyright 2022 All Right Reserved By Arif Muhamma Iqbal</a></p>
                  </div>
               </div>
            </div>
         </div>
