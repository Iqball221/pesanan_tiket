                ...
                <div class="container-fluid">
                    ...
                    <div class="col-lg-12">
                            ...
                            <div class="panel-heading">
                                    Data Tiket
                                    <a href="{{ route('tiket.create') }}" class = "btn btn-primary float-righht">Tambah</a>
                                </div>
                                <!-- /.panel-heading -->
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <a href="{{ route('tiket.edit', $data->id) }}" class = "btn btn-success float-right">Ubah</a>
                                                        <a href="{{ route('tiket.show', $data->id) }}" class = "btn btn-warning float-right">Tampil</a>
